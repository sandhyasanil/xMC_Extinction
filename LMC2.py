...
class LMC2Extinction:
    ...
    rv : float, optional
        Total-to-selective extinction ratio. Default is 2.76.
    """

    def __init__(self, x, rv=2.76):
        self.x = x
        self.rv = rv
